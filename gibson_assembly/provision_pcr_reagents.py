...
reagent_plate = p.ref("pcr_reagent_plate", cont_type="96-pcr", storage="cold_20",  discard=False)

#create a container 

#We use 1uL per set of 4 experiments. To get 4 sets of experiments, we need 8uL
q5_poly_well = reagent_plate.wells(["A1"])[0]
...
q5_buffer_well = reagent_plate.wells(["A2"])[0]
...
q5_enhancer_well = reagent_plate.wells(["A3"])[0]
